...
struct Addtask1month: View {
    @State private var navigateToAddTask1Day = false
    ...
    var body: some View {
            ZStack() {
                ...
                .fullScreenCover(isPresented: $navigateToTask1MonthView) {
                    task_1month_(viewModel: TaskViewModel()) // データバインディングや追加の機能に応じて追加設定が必要になる場合があります。
                }
                ...
                ZStack() {
                        ...
                        .background(
                            NavigationLink("", destination: Addtask1dayView()
                              .navigationBarBackButtonHidden(true), isActive: $navigateToAddTask1Day)
                        )
...
struct Addtask1month_Previews: PreviewProvider {
